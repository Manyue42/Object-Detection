            ...
            while 1:
                ...
                if cv2.waitKey(100) & 0xFF == ord('q'):
                    ...
                    if width > 30 and height > 30:
                        ...
                        cv2.putText(img, object1, point1, cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255,0), 3)
                    ...
                    if width > 30 and height > 30:
                        ...
                        cv2.putText(img, object2, point1, cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 3)
                        print('w')
                    else:
                        print('!!!!!!!!!!!!!!')
                    ...
                    if width > 30 and height > 30:
                        ...
                        cv2.putText(img, object3, point1, cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 3)
                        print('e')
                    else:
                        print('!!!!!!!!!!!!!!')
